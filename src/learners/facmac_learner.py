...
class FACMACLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        self.critic.init_hidden(batch.batch_size)
        for t in range(batch.max_seq_length):
            # print("Training Batch size:", batch.batch_size, batch.max_seq_length, t)
    ...
    def _build_inputs(self, batch, t):
        ...
        # output info
        # self.logger.console_logger.info("Obs dim:"+str(batch["obs"][:, t].shape)+" Act dim:"+str(batch["actions"][:, t].shape)+" All dim:"+str(inputs.shape))
        # self.logger.console_logger.info("N actions:"+str(self.args.n_actions))
