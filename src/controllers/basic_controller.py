...
Also, add functions for communication 
"""
class BasicMAC:
    def __init__(self, scheme, groups, args):
        ...
        # build for communication
        self.comm_hidden_states = None
        self.msg_spaces = None
        self.comm = None
    ...
    """
        build communication for controller
    """
    def _build_comm(self, input_shape):
        pass

    # build input for communication
    def _build_comm_inputs(self, batch, t):
        pass
