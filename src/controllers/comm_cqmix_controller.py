...
class CCQMixMAC(BasicMAC):
    
    def __init__(self, scheme, groups, args):
        super(CCQMixMAC, self).__init__(scheme, groups, args)
    ...
    def forward(self, ep_batch, t, actions=None, hidden_states=None, select_actions=False, test_mode=False, use_direct=False, bs=slice(None)):
        agent_inputs = self._build_inputs(ep_batch, t, bs=bs, use_direct=use_direct)
    ...
    def _build_inputs(self, batch, t, bs=slice(None), use_direct=False, target_mac=False, last_target_action=None):
    ...
    def forward_comm(self, ep_batch, t, messages=None, select_messages=False, comm_hidden_states=None, bs=slice(None)):
        ...
        # print("Comm hidden_states:", comm_hidden_states.shape, comm_inputs.shape, t, ep_batch.batch_size)
