...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, shared_viewer=True, observable_agents=None):
        ...
        self.observable_agents = observable_agents
    ...
    def _get_observable_agents(self, agent):
        return self.observable_agents(agent, self.world)
