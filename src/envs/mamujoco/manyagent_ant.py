...
class ManyAgentAntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, **kwargs):
        ...
        asset_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'assets', "manyagent", "ant"
                                                  'ant_{}_agents_each_{}_segments_{}.xml'.format(n_agents, n_segs_per_agents, env_id))
        print("Auto-Generating {}-index Manyagent Ant asset with {} segments at {}.".format(env_id, n_segs, asset_path))
